...
class TestIntegracionCLI(unittest.TestCase):
    ...
    def test_version_actualizada(self):
        ...
        with open(ruta, encoding="utf-8") as fh:
            self.assertIn('version = "6.12.0"', fh.read())
